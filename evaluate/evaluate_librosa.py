#!/usr/bin/env python3
"""
Evaluate Librosa pitch tracking predictions.

This script evaluates Librosa predictions across different experimental conditions:
- Clean (baseline)
- Distortion
- Noise (5db, 15db)
...
def main():
    ...
    experiments = {
        'clean': {
            'prediction_dir': 'results/predictions/librosa_normalized/clean',
            'ground_truth_dir': 'MedleyDB-Pitch/pitch',
            'output_path': 'results/metrics/librosa_clean.csv'
        },
        'distortion': {
            'prediction_dir': 'results/predictions/librosa_normalized/distortion',
            'ground_truth_dir': 'MedleyDB-Pitch-Experiments/pitch',
            'output_path': 'results/metrics/librosa_distortion.csv'
        },
        'noise_5db': {
            'prediction_dir': 'results/predictions/librosa_normalized/noise/5db',
            'ground_truth_dir': 'MedleyDB-Pitch-Experiments/pitch',
            'output_path': 'results/metrics/librosa_noise_5db.csv'
        },
        'noise_15db': {
            'prediction_dir': 'results/predictions/librosa_normalized/noise/15db',
            'ground_truth_dir': 'MedleyDB-Pitch-Experiments/pitch',
            'output_path': 'results/metrics/librosa_noise_15db.csv'
        },
        'pitch_shift_25cents': {
            'prediction_dir': 'results/predictions/librosa_normalized/pitch_shift/25cents',
            'ground_truth_dir': 'MedleyDB-Pitch-Experiments/pitch',
            'output_path': 'results/metrics/librosa_pitch_shift_25cents.csv'
        },
        'pitch_shift_50cents': {
            'prediction_dir': 'results/predictions/librosa_normalized/pitch_shift/50cents',
            'ground_truth_dir': 'MedleyDB-Pitch-Experiments/pitch',
            'output_path': 'results/metrics/librosa_pitch_shift_50cents.csv'
        }
    }
    
    print("=" * 60)
    print("Librosa Pitch Tracking Evaluation")
    print("=" * 60)
